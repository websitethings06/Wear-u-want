    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">WearUWant</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/shop?category=men" className="text-gray-300 hover:text-white">Men</Link></li>
              <li><Link to="/shop?category=women" className="text-gray-300 hover:text-white">Women</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><button className="text-gray-300 hover:text-white">Shipping Info</button></li>
              <li><button className="text-gray-300 hover:text-white">Returns</button></li>
              <li><button className="text-gray-300 hover:text-white">Size Guide</button></li>
              <li><button className="text-gray-300 hover:text-white">FAQ</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-3 py-2 bg-gray-700 text-white rounded-l-md focus:outline-none focus:bg-gray-600"
              />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 WearUWant. All rights reserved.
          </p>
