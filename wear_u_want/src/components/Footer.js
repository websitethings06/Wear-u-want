  ...
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap justify-center items-center space-x-8 text-sm text-gray-600 mb-8">
          <Link to="/about" className="hover:text-gray-900 transition-colors">About Us</Link>
          <Link to="/weststyle-club" className="hover:text-gray-900 transition-colors">WearStyleClub</Link>
          <Link to="/w-style" className="hover:text-gray-900 transition-colors">W-Style</Link>
          <Link to="/gift-card" className="hover:text-gray-900 transition-colors">Gift Card</Link>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-4">Get the latest updates on new collections and exclusive offers</p>
          <div className="max-w-md mx-auto flex">
            ...
            />
            <button className="bg-gray-900 text-white px-6 py-2 rounded-r-md hover:bg-gray-800 transition-colors">
              Subscribe
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-200 pt-8">
          <div className="flex items-center space-x-6 mb-4 md:mb-0">
            <span className="text-2xl font-bold text-gray-900">Wear U Want</span>
        ...
        <div className="text-center mt-8 pt-8 border-t border-gray-200">
          <p className="text-gray-500 text-sm">
            © 2025 Wear U Want. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
