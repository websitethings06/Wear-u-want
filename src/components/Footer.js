        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com/wearuwant" className="text-gray-300 hover:text-white" aria-label="Follow us on Twitter">
              ...
              <a href="https://pinterest.com/wearuwant" className="text-gray-300 hover:text-white" aria-label="Follow us on Pinterest">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
