      ...
      <section className="relative bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white">
        ...
        <div className="relative container mx-auto px-4 py-24 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
            Discover premium quality clothing and accessories that match your unique style. From casual wear to formal attire, we've got everything you need.
          </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link to="/shop?category=men" className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-white/90">Style that speaks volumes</p>
              </div>
            </Link>

            <Link to="/shop?category=women" className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="aspect-w-4 aspect-h-5">
                <img
                  src="https://images.unsplash.com/photo-1494790108755-2616c96d37fe?w=500&h=600&fit=crop"
                  alt="Women's Fashion"
                  className="w-full h-80 object-cover group-hover:scale-105 transition-transform duration-300"
                />
              </div>
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-white/90">Elegance redefined</p>
              </div>
            </Link>

            <Link to="/shop?category=accessories" className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="aspect-w-4 aspect-h-5">
                <img
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-white/90">Perfect finishing touches</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Link
              to="/shop"
              className="bg-gray-800 text-white px-8 py-4 rounded-full hover:bg-gray-700 transition-colors inline-flex items-center gap-2 text-lg font-medium"
            >
              View All Products
